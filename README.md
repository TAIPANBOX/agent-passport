...
| `typryx` | typed answers with a probability, an optional add-on (it writes and calls nobody else in the stack) | `typed_answer` (info) · `typed_unanswered` (medium) · `typed_refused` (high) · `calibration_drift` (high) |
